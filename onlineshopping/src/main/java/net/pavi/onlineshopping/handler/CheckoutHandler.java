package net.pavi.onlineshopping.handler;
...
import net.pavi.onlineshopping.model.CheckoutModel;
import net.pavi.onlineshopping.model.UserModel;
import net.pavi.shoppingbackend.dao.CartLineDAO;
import net.pavi.shoppingbackend.dao.ProductDAO;
import net.pavi.shoppingbackend.dao.UserDAO;
import net.pavi.shoppingbackend.dto.Address;
import net.pavi.shoppingbackend.dto.Cart;
import net.pavi.shoppingbackend.dto.CartLine;
import net.pavi.shoppingbackend.dto.OrderDetail;
import net.pavi.shoppingbackend.dto.OrderItem;
import net.pavi.shoppingbackend.dto.Product;
import net.pavi.shoppingbackend.dto.User;
