package net.pavi.onlineshopping.controller;
...
import net.pavi.onlineshopping.util.FileUtil;
import net.pavi.onlineshopping.validator.ProductValidator;
import net.pavi.shoppingbackend.dao.CategoryDAO;
import net.pavi.shoppingbackend.dao.ProductDAO;
import net.pavi.shoppingbackend.dto.Category;
